...
#pdnsutil secure-zone dailygold.tw
#pdnsutil add-zone-key dailygold.tw  ksk 2048 active rsasha256
#pdnsutil add-zone-key dailygold.tw  zsk 1024 active rsasha256
